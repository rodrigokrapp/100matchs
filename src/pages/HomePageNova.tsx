    ...
    <div style={styles.homepage}>
      ...
      <header style={styles.header}>
        <div style={styles.container}>
          <h1 style={styles.logo}>RESENHA sem Matchs</h1>
          ...
          <div style={styles.heroContent}>
            ...
            <div style={styles.heroCenter}>
              <div style={styles.formContainer}>
                <h2 style={styles.title}>Conheça pessoas do seu bairro!</h2>
                <p style={styles.subtitle}>Entre como visitante gratuito e comece agora!</p>
      ...
      <section style={styles.features}>
        <div style={styles.container}>
          <h3 style={styles.featuresTitle}>Por que escolher o Resenha sem Matchs?</h3>
